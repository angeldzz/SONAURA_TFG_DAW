...
(83, 'Narcos', 'serie', 'El poder tiene un precio', 'La historia del ascenso y caída de los carteles de droga colombianos, centrada en Pablo Escobar y los agentes que lo persiguen. Este drama combina crimen, política y tensión en un relato implacable.', 2015, 50, 'Chris Brancato', 'Chris Brancato', 'TV-MA', 'posters/Narcos.jpg', 'Narcos', NULL, NULL, 4.2, 0, NOW(), NOW(), 1),
(84, 'The Boys', 'serie', 'Los héroes no siempre son buenos', 'En un mundo donde los superhéroes son corruptos, un grupo de vigilantes lucha para exponer sus crímenes. Esta sátira de acción combina violencia, humor negro y críticas al poder y la fama.', 2019, 60, 'Eric Kripke', 'Eric Kripke', 'TV-MA', 'posters/TheBoys.jpg', 'The Boys', NULL, NULL, 4.2, 0, NOW(), NOW(), 1),
(85, 'Ozark', 'serie', 'El dinero lo cambia todo', 'Marty Byrde, un asesor financiero, traslada a su familia a los Ozarks para lavar dinero para un cartel. Este thriller explora el crimen, la familia y las decisiones desesperadas en un mundo peligroso.', 2017, 60, 'Bill Dubuque', 'Bill Dubuque', 'TV-MA', 'posters/Ozark.jpg', 'Ozark', NULL, NULL, 4.1, 0, NOW(), NOW(), 1),
(86, 'Chernobyl', 'serie', 'La verdad tiene un costo', 'Tras el desastre nuclear de Chernobyl, científicos y funcionarios arriesgan todo para contener la catástrofe. Este drama histórico recrea los eventos con intensidad, mostrando el sacrificio y el encubrimiento.', 2019, 65, 'Craig Mazin', 'Craig Mazin', 'TV-MA', 'posters/Chernobyl.jpg', 'Chernobyl', NULL, NULL, 4.5, 0, NOW(), NOW(), 1),
(87, 'The Queen’s Gambit', 'serie', 'El jaque mate es solo el comienzo', 'Beth Harmon, una joven prodigio del ajedrez, enfrenta adicciones y sexismo mientras asciende en un mundo dominado por hombres. Este drama combina intensidad emocional y una historia de superación.', 2020, 60, 'Scott Frank', 'Scott Frank', 'TV-MA', 'posters/TheQueensGambit.jpg', 'The Queen’s Gambit', NULL, NULL, 4.1, 0, NOW(), NOW(), 1),
(88, 'Mindhunter', 'serie', 'Dentro de la mente criminal', 'En los 70, agentes del FBI desarrollan técnicas de perfilación psicológica entrevistando a asesinos en serie. Este thriller explora la oscuridad de la mente humana y los inicios de la criminología moderna.', 2017, 60, 'Joe Penhall', 'Joe Penhall', 'TV-MA', 'posters/Mindhunter.jpg', 'Mindhunter', NULL, NULL, 4.1, 0, NOW(), NOW(), 1),
(89, 'The Handmaid’s Tale', 'serie', 'Bajo su ojo', 'En una distopía donde las mujeres son subyugadas, June lucha por sobrevivir y encontrar a su hija en un régimen totalitario. Este drama explora la opresión, la resistencia y la esperanza en un mundo oscuro.', 2017, 50, 'Bruce Miller', 'Bruce Miller', 'TV-MA', 'posters/TheHandmaidsTale.jpg', 'The Handmaid’s Tale', NULL, NULL, 4.0, 0, NOW(), NOW(), 1),
(90, 'Vikings', 'serie', 'La leyenda comienza', 'Ragnar Lothbrok, un guerrero vikingo, lidera incursiones y explora nuevos mundos mientras enfrenta traiciones y dioses. Esta épica histórica combina acción, mitología y dramas familiares.', 2013, 45, 'Michael Hirst', 'Michael Hirst', 'TV-MA', 'posters/Vikings.jpg', 'Vikings', NULL, NULL, 4.0, 0, NOW(), NOW(), 1),
(91, 'Peaky Blinders', 'serie', 'Por orden de los Peaky Blinders', 'En Birmingham post Primera Guerra Mundial, la familia Shelby lidera una banda criminal con ambiciones de poder. Este drama combina crimen, política y traiciones en un mundo de gánsteres.', 2013, 60, 'Steven Knight', 'Steven Knight', 'TV-MA', 'posters/PeakyBlinders.jpg', 'Peaky Blinders', NULL, NULL, 4.2, 0, NOW(), NOW(), 1),
(92, 'The Last of Us', 'serie', 'El amor en el fin del mundo', 'En un mundo devastado por un hongo, Joel y Ellie, una adolescente inmune, cruzan un Estados Unidos postapocalíptico. Este drama explora la supervivencia, el vínculo humano y la esperanza en la desesperación.', 2023, 60, 'Craig Mazin', 'Craig Mazin, Neil Druckmann', 'TV-MA', 'posters/TheLastOfUs.jpg', 'The Last of Us', NULL, NULL, 4.3, 0, NOW(), NOW(), 1),
(93, 'Euphoria', 'serie', 'La vida es un caos', 'Un grupo de adolescentes navega el amor, las adicciones y la identidad en un mundo hiperconectado. Este drama crudo explora los desafíos de la juventud con una estética audaz y emociones intensas.', 2019, 60, 'Sam Levinson', 'Sam Levinson', 'TV-MA', 'posters/Euphoria.jpg', 'Euphoria', NULL, NULL, 4.0, 0, NOW(), NOW(), 1),
(94, 'Yellowstone', 'serie', 'La tierra es la guerra', 'La familia Dutton protege su rancho en Montana contra desarrolladores, políticos y enemigos. Este drama moderno combina intrigas familiares, poder y conflictos territoriales en un Oeste contemporáneo.', 2018, 60, 'Taylor Sheridan', 'Taylor Sheridan', 'TV-MA', 'posters/Yellowstone.jpg', 'Yellowstone', NULL, NULL, 4.1, 0, NOW(), NOW(), 1),
(95, 'Ted Lasso', 'serie', 'La bondad siempre gana', 'Ted Lasso, un entrenador de fútbol americano, lidera un equipo de fútbol inglés con optimismo y corazón. Esta comedia explora la empatía, el liderazgo y la superación en un mundo competitivo.', 2020, 30, 'Jason Sudeikis', 'Jason Sudeikis, Bill Lawrence', 'TV-MA', 'posters/TedLasso.jpg', 'Ted Lasso', NULL, NULL, 4.2, 0, NOW(), NOW(), 1),
(96, 'House M.D.', 'serie', 'Todos mienten', 'El Dr. Gregory House, un médico brillante pero excéntrico, resuelve casos médicos complejos con métodos poco convencionales. Este drama combina misterio, humor y dilemas éticos en un hospital.', 2004, 45, 'David Shore', 'David Shore', 'TV-14', 'posters/HouseMD.jpg', 'House M.D.', NULL, NULL, 4.2, 0, NOW(), NOW(), 1),
(97, 'Dexter', 'serie', 'El asesino con código', 'Dexter Morgan, un forense que es secretamente un asesino en serie, mata a criminales que escapan de la justicia. Este thriller psicológico explora la moralidad, la identidad y el control en un mundo oscuro.', 2006, 55, 'Jeff Dunham', 'Jeff Dunham', 'TV-MA', 'posters/Dexter.jpg', 'Dexter', NULL, NULL, 4.1, 0, NOW(), NOW(), 1),
...
(99, 'Modern Family', 'serie', 'La familia es un caos', 'Tres familias interconectadas enfrentan la vida moderna con humor y amor. Esta comedia mockumentary explora la diversidad, las relaciones y los retos de la familia en un mundo cambiante.', 2009, 22, 'Christopher Lloyd', 'Christopher Lloyd, Steven Levitan', 'TV-PG', 'posters/ModernFamily.jpg', 'Modern Family', NULL, NULL, 4.1, 0, NOW(), NOW(), 1),
(100, 'The West Wing', 'serie', 'El poder detrás del poder', 'El presidente de EE.UU. y su equipo enfrentan crisis políticas y personales en la Casa Blanca. Este drama combina diálogos brillantes, idealismo y los retos del liderazgo en un mundo complejo.', 1999, 45, 'Aaron Sorkin', 'Aaron Sorkin', 'TV-14', 'posters/TheWestWing.jpg', 'The West Wing', NULL, NULL, 4.3, 0, NOW(), NOW(), 1),
(101, 'Boardwalk Empire', 'serie', 'El crimen reina', 'En Atlantic City durante la Prohibición, Nucky Thompson lidera un imperio criminal mientras enfrenta rivales y el gobierno. Este drama histórico combina ambición, traición y el glamour de los años 20.', 2010, 55, 'Terence Winter', 'Terence Winter', 'TV-MA', 'posters/BoardwalkEmpire.jpg', 'Boardwalk Empire', NULL, NULL, 4.1, 0, NOW(), NOW(), 1),
(102, 'Sons of Anarchy', 'serie', 'La lealtad es todo', 'Jax Teller, líder de un club de motociclistas, enfrenta conflictos internos y externos mientras protege a su familia y su legado. Este drama explora el crimen, la lealtad y la redención en un mundo brutal.', 2008, 45, 'Kurt Sutter', 'Kurt Sutter', 'TV-MA', 'posters/SonsOfAnarchy.jpg', 'Sons of Anarchy', NULL, NULL, 4.1, 0, NOW(), NOW(), 1),
(103, 'The Expanse', 'serie', 'El universo es el límite', 'En un futuro donde la humanidad coloniza el sistema solar, un detective, un capitán y una diplomática descubren una conspiración que amenaza la paz. Esta épica de ciencia ficción combina política y acción.', 2015, 45, 'Mark Fergus', 'Mark Fergus, Hawk Ostby', 'TV-14', 'posters/TheExpanse.jpg', 'The Expanse', NULL, NULL, 4.1, 0, NOW(), NOW(), 1),
(104, 'Downton Abbey', 'serie', 'La tradición frente al cambio', 'La familia Crawley y sus sirvientes navegan la vida en una mansión inglesa durante el siglo XX. Este drama histórico explora el amor, la clase y los cambios sociales con elegancia y emoción.', 2010, 50, 'Julian Fellowes', 'Julian Fellowes', 'TV-PG', 'posters/DowntonAbbey.jpg', 'Downton Abbey', NULL, NULL, 4.2, 0, NOW(), NOW(), 1),
(105, 'Atlanta', 'serie', 'La vida es un escenario', 'Earn y su primo Alfred, un rapero en ascenso, enfrentan la vida y la fama en Atlanta. Esta comedia dramática combina surrealismo, humor y comentarios sociales sobre la raza y la cultura.', 2016, 30, 'Donald Glover', 'Donald Glover', 'TV-MA', 'posters/Atlanta.jpg', 'Atlanta', NULL, NULL, 4.1, 0, NOW(), NOW(), 1),
(106, 'Hannibal', 'serie', 'El depredador perfecto', 'Will Graham, un profiler del FBI, colabora con el psiquiatra Hannibal Lecter para atrapar asesinos. Este thriller psicológico explora la mente criminal y la oscuridad con una estética hipnótica.', 2013, 45, 'Bryan Fuller', 'Bryan Fuller', 'TV-MA', 'posters/Hannibal.jpg', 'Hannibal', NULL, NULL, 4.0, 0, NOW(), NOW(), 1),
(107, 'Fleabag', 'serie', 'La vida es un desastre', 'Una joven londinense enfrenta la vida, el amor y la familia con humor y caos. Esta comedia dramática, narrada con ingenio y ruptura de la cuarta pared, explora la vulnerabilidad y la autenticidad.', 2016, 25, 'Phoebe Waller-Bridge', 'Phoebe Waller-Bridge', 'TV-MA', 'posters/Fleabag.jpg', 'Fleabag', NULL, NULL, 4.2, 0, NOW(), NOW(), 1),
(108, 'The Good Place', 'serie', 'El paraíso no es lo que parece', 'Eleanor, una mujer egoísta, llega por error a un paraíso utópico tras su muerte. Este drama cómico explora la moralidad, la redención y la filosofía con humor y giros inesperados.', 2016, 25, 'Michael Schur', 'Michael Schur', 'TV-PG', 'posters/TheGoodPlace.jpg', 'The Good Place', NULL, NULL, 4.0, 0, NOW(), NOW(), 1),
(109, 'This Is Us', 'serie', 'La vida nos conecta', 'La familia Pearson enfrenta alegrías y tragedias a través de generaciones. Este drama emocional explora el amor, la pérdida y las conexiones humanas con una narrativa conmovedora y no lineal.', 2016, 45, 'Dan Fogelman', 'Dan Fogelman', 'TV-14', 'posters/ThisIsUs.jpg', 'This Is Us', NULL, NULL, 4.2, 0, NOW(), NOW(), 1),
